...
export const wilayas = [
  { id: 1, name: { en: "Adrar", ar: "أدرار" }, price: { home: 1100, stopDesk: 850 }, maps: "https://maps.app.goo.gl/XG8P5yn7k9xp2MVh8" },
  { id: 2, name: { en: "Chlef", ar: "الشلف" }, price: { home: 700, stopDesk: 400 }, maps: "https://maps.app.goo.gl/mkn4J7rmHDNCb2kNA" },
  { id: 3, name: { en: "Laghouat", ar: "الأغواط" }, price: { home: 800, stopDesk: 450 }, maps: "https://maps.app.goo.gl/eXXfYcWFs7Tj3U1o6" },
  { id: 4, name: { en: "Oum El Bouaghi", ar: "أم البواقي" }, price: { home: 700, stopDesk: 450 }, maps: "https://maps.app.goo.gl/mnygK5DkhvYe6Gi79" },
  { id: 5, name: { en: "Batna", ar: "باتنة" }, price: { home: 700, stopDesk: 400 }, maps: "https://maps.app.goo.gl/Ce9EStPRvhjyvT7T7" },
  { id: 6, name: { en: "Béjaïa", ar: "بجاية" }, price: { home: 700, stopDesk: 400 }, maps: "https://maps.app.goo.gl/grh58Gfe7X3rXhDd7" },
  { id: 7, name: { en: "Biskra", ar: "بسكرة" }, price: { home: 700, stopDesk: 450 }, maps: "https://maps.app.goo.gl/cZncQXHXdGfoiyQi7" },
  { id: 8, name: { en: "Béchar", ar: "بشار" }, price: { home: 1000, stopDesk: 750 }, maps: "https://maps.app.goo.gl/2H41H8UbR3tsR7Cg9" },
  { id: 9, name: { en: "Blida", ar: "البليدة" }, price: { home: 500, stopDesk: 300 }, maps: "https://maps.app.goo.gl/dGcHwhJwJK7FG5ur6" },
  { id: 10, name: { en: "Bouira", ar: "البويرة" }, price: { home: 700, stopDesk: 400 }, maps: "https://maps.app.goo.gl/oFhWf7KxMzEngZWi6" },
  { id: 11, name: { en: "Tamanrasset", ar: "تمنراست" }, price: { home: 1100, stopDesk: 900 }, maps: "https://maps.app.goo.gl/ijZcgnPkrR3sHJ796" },
  { id: 12, name: { en: "Tébessa", ar: "تبسة" }, price: { home: 800, stopDesk: 450 }, maps: "https://maps.app.goo.gl/XscBidbLuWEmoCxV8" },
  { id: 13, name: { en: "Tlemcen", ar: "تلمسان" }, price: { home: 700, stopDesk: 450 }, maps: "https://maps.app.goo.gl/cYvUxxKqES1kuDaJ7" },
  { id: 14, name: { en: "Tiaret", ar: "تيارت" }, price: { home: 700, stopDesk: 400 }, maps: "https://maps.app.goo.gl/WXbNNLT4frkzxr7S8" },
  { id: 15, name: { en: "Tizi Ouzou", ar: "تيزي وزو" }, price: { home: 700, stopDesk: 400 }, maps: "https://maps.app.goo.gl/H6koW8zGGU8by1Mb9" },
  {
    id: 16,
    name: { en: "Alger", ar: "الجزائر العاصمة" },
    price: { home: 400, stopDesk: 250 },
    maps: [
      { label: { en: "Ain Naadja", ar: "عين النعجة" }, url: "https://maps.app.goo.gl/99RDCNEjBAToLqTF6" },
      { label: { en: "Chéraga", ar: "الشراقة" }, url: "https://maps.app.goo.gl/52hZivMd9Q2oMAZP7" },
    ],
  },
  { id: 17, name: { en: "Djelfa", ar: "الجلفة" }, price: { home: 750, stopDesk: 450 }, maps: "https://maps.app.goo.gl/S1kY6qU1MKbUmEKHA" },
  { id: 18, name: { en: "Jijel", ar: "جيجل" }, price: { home: 700, stopDesk: 400 }, maps: "https://maps.app.goo.gl/9YpusezggYmhbNik7" },
  {
    id: 19,
    name: { en: "Sétif", ar: "سطيف" },
    price: { home: 700, stopDesk: 350 },
    maps: [
      { label: { en: "Sétif", ar: "سطيف" }, url: "https://maps.app.goo.gl/1SD9xAVAy7kJCXJu6" },
      { label: { en: "El Eulma", ar: "العلمة" }, url: "https://maps.app.goo.gl/ZrwJQ6S7toAtTmig8" },
    ],
  },
  { id: 20, name: { en: "Saïda", ar: "سعيدة" }, price: { home: 700, stopDesk: 550 }, maps: "https://maps.app.goo.gl/xKxaHViAvdtcyzJ27" },
  { id: 21, name: { en: "Skikda", ar: "سكيكدة" }, price: { home: 700, stopDesk: 350 }, maps: "https://maps.app.goo.gl/48Xq2jbBj9ffaqD28" },
  { id: 22, name: { en: "Sidi Bel Abbès", ar: "سيدي بلعباس" }, price: { home: 700, stopDesk: 400 }, maps: "https://maps.app.goo.gl/SfZYXgpRgTJgwV2dA" },
  { id: 23, name: { en: "Annaba", ar: "عنابة" }, price: { home: 700, stopDesk: 450 }, maps: "https://maps.app.goo.gl/LeJvFbEtfprj5FZAA" },
  { id: 24, name: { en: "Guelma", ar: "قالمة" }, price: { home: 700, stopDesk: 500 }, maps: "https://maps.app.goo.gl/HKhqWwFKQ5wfYQaT7" },
  { id: 25, name: { en: "Constantine", ar: "قسنطينة" }, price: { home: 700, stopDesk: 400 }, maps: "https://maps.app.goo.gl/nNZyXqaqW2gJHWaP8" },
  { id: 26, name: { en: "Médéa", ar: "المدية" }, price: { home: 600, stopDesk: 300 }, maps: "https://g.co/kgs/RC6MZ43" },
  { id: 27, name: { en: "Mostaganem", ar: "مستغانم" }, price: { home: 700, stopDesk: 400 }, maps: "https://maps.app.goo.gl/muckSAHTrs2W7g7W8" },
  { id: 28, name: { en: "M'Sila", ar: "المسيلة" }, price: { home: 700, stopDesk: 350 }, maps: "https://maps.app.goo.gl/ktuwwFganUX4ZW2P6" },
  { id: 29, name: { en: "Mascara", ar: "معسكر" }, price: { home: 700, stopDesk: 450 }, maps: "https://maps.app.goo.gl/1iokJ5EUfxsJGR7S6" },
  { id: 30, name: { en: "Ouargla", ar: "ورقلة" }, price: { home: 800, stopDesk: 500 }, maps: "https://maps.app.goo.gl/7j9cFoPJTCcKZYdb7" },
  { id: 31, name: { en: "Oran", ar: "وهران" }, price: { home: 700, stopDesk: 400 }, maps: "https://goo.gl/maps/CStcvHFXjqbRW4n69" },
  { id: 32, name: { en: "El Bayadh", ar: "البيض" }, price: { home: 900, stopDesk: 500 }, maps: "https://maps.app.goo.gl/naiP64nQXfDPpXEe6" },
  { id: 33, name: { en: "Illizi", ar: "اليزي" }, price: { home: 1200, stopDesk: 1100 }, maps: "https://maps.app.goo.gl/r3Cbw4MnPwEV1oQA6" },
  { id: 34, name: { en: "Bordj Bou Arréridj", ar: "برج بوعريريج" }, price: { home: 700, stopDesk: 350 }, maps: "https://maps.app.goo.gl/VUs8wsyez6a58uyB9" },
  { id: 35, name: { en: "Boumerdès", ar: "بومرداس" }, price: { home: 600, stopDesk: 300 }, maps: "https://maps.app.goo.gl/xxgwUkqomz59Ceyd8" },
  { id: 36, name: { en: "El Tarf", ar: "الطارف" }, price: { home: 700, stopDesk: 450 }, maps: "https://maps.app.goo.gl/h1d4bQ1fDQ45wV2E9" },
  { id: 37, name: { en: "Tindouf", ar: "تندوف" }, price: { home: 1300, stopDesk: 850 }, maps: "https://maps.app.goo.gl/SJxqEu3ryX8dsJdK6" },
  { id: 38, name: { en: "Tissemsilt", ar: "تسمسيلت" }, price: { home: 700, stopDesk: 400 }, maps: "https://maps.app.goo.gl/Fjamg9cdS1Y5emHV9" },
  { id: 39, name: { en: "El Oued", ar: "الوادي" }, price: { home: 700, stopDesk: 550 }, maps: "https://maps.app.goo.gl/kRqn1yTman9oV4CPA" },
  { id: 40, name: { en: "Khenchela", ar: "خنشلة" }, price: { home: 700, stopDesk: 450 }, maps: "https://goo.gl/maps/4yEWshy949Ls12pA8" },
  { id: 41, name: { en: "Souk Ahras", ar: "سوق اهراس" }, price: { home: 700, stopDesk: 400 }, maps: "https://maps.app.goo.gl/Xe7iUYktPuU3RFAJA" },
  { id: 42, name: { en: "Tipaza", ar: "تيبازة" }, price: { home: 600, stopDesk: 400 }, maps: "https://maps.app.goo.gl/g5LswiaL3KKo7hJ38" },
  { id: 43, name: { en: "Mila", ar: "ميلة" }, price: { home: 700, stopDesk: 400 }, maps: "https://maps.app.goo.gl/CByxrw1WgvkbXCL38" },
  { id: 44, name: { en: "Aïn Defla", ar: "عين الدفلى" }, price: { home: 700, stopDesk: 400 }, maps: "https://maps.app.goo.gl/cPrteUVe5pgyhFzQ8" },
  { id: 45, name: { en: "Naâma", ar: "النعامة" }, price: { home: 900, stopDesk: 650 }, maps: "https://maps.app.goo.gl/ges5SkRW8g7LnejYA" },
  { id: 46, name: { en: "Aïn Témouchent", ar: "عين تموشنت" }, price: { home: 700, stopDesk: 450 }, maps: "https://maps.app.goo.gl/uxgfxDTsVRuxj1Wr8" },
  { id: 47, name: { en: "Ghardaïa", ar: "غرداية" }, price: { home: 800, stopDesk: 450 }, maps: "https://maps.app.goo.gl/6JwcJi9q9u5ES2oA6" },
  { id: 48, name: { en: "Relizane", ar: "غليزان" }, price: { home: 700, stopDesk: 400 }, maps: "https://maps.app.goo.gl/otpHg5uFaKhdAVYH6" },
  { id: 49, name: { en: "Timimoun", ar: "تميمون" }, price: { home: 1000, stopDesk: 750 }, maps: "https://maps.app.goo.gl/9M2pEWAjDHAaUrKF8" },
  { id: 51, name: { en: "Ouled Djellal", ar: "اولاد جلال" }, price: { home: 800, stopDesk: 600 }, maps: "https://www.google.com/maps/place/C3P9%2BHGC+H%C3%B4tel+Transit,+Ouled+Djellal" },
  { id: 52, name: { en: "Beni Abbès", ar: "بني عباس" }, price: { home: 1200, stopDesk: 700 }, maps: "https://goo.gl/maps/rCxc9J3jwhSotbuB6" },
  { id: 53, name: { en: "In Salah", ar: "عين صالح" }, price: { home: 1000, stopDesk: 1000 }, maps: "https://maps.app.goo.gl/E8boeiuC6jKRZr3f9" },
  { id: 55, name: { en: "Touggourt", ar: "تقرت" }, price: { home: 800, stopDesk: 550 }, maps: "https://maps.app.goo.gl/pEqpj6dobLV9MLDw9" },
  { id: 57, name: { en: "El M'Ghair", ar: "المغير" }, price: { home: 800, stopDesk: 0 }, maps: null },
  { id: 58, name: { en: "El Meniaa", ar: "المنيعة" }, price: { home: 1000, stopDesk: 700 }, maps: "https://maps.app.goo.gl/JN34ACNxT1jq1JZGA" },
];
