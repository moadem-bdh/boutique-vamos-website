...
export default function OurServices() {
  ...
  return (
    <section
      id="services"
      className="bg-white py-10 md:py-14 lg:py-16 xl:py-20 w-full px-4 md:px-6 lg:px-10 xl:px-20"
    >
      <div className="h-full w-full flex flex-col md:grid md:grid-cols-2 md:auto-rows-auto lg:grid-cols-6 lg:auto-rows-auto gap-6 md:gap-4 lg:gap-5 xl:gap-6">
        ...
        <MotionWrapper
          variants={scaleUp}
          duration={0.6}
          className="md:col-span-2 lg:col-span-4 row-span-1 bg-black rounded-4xl p-5 md:p-6 flex flex-col md:flex-row lg:flex-row gap-5"
        >
        ...
        <MotionWrapper
          variants={fadeUp}
          delay={0.1}
          className="mb-2 lg:mb-0 order-first md:order-first lg:order-0 md:col-span-2 lg:col-span-2 row-span-1 bg-white gap-4 md:gap-2 lg:gap-3 xl:gap-3 flex flex-col md:items-center md:text-center lg:items-start lg:text-start"
        >
        ...
        <MotionWrapper
          ...
          delay={0.15}
          duration={0.55}
          className="md:col-span-1 lg:col-span-2 row-span-1 gap-4 md:gap-3 lg:gap-0 bg-black rounded-4xl p-6 md:p-5 lg:p-5 xl:p-7 text-white flex flex-col justify-between"
        >
        ...
        <MotionWrapper
          ...
          delay={0.1}
          duration={0.6}
          className="hidden md:flex md:col-span-1 lg:col-span-4 row-span-1 bg-black rounded-4xl p-5 md:p-5 lg:p-5 xl:p-6 md:flex-col lg:flex-row gap-5"
        >
