...
export default function AboutCards({ bgUrl , heading , subHeading }: { bgUrl: string ,heading:string ,subHeading:string }) {
  return (
    <div className="relative items-start bg-black w-full  lg:flex-1 max-w-84  lg:shrink min-w-70 h-103 p-5 flex flex-col justify-end  gap-2 overflow-hidden rounded-2xl">
      <div
